...
class RenewMembershipScreen extends StatefulWidget {
  ...
  const RenewMembershipScreen({super.key, required this.client});
...
class _RenewMembershipScreenState extends State<RenewMembershipScreen> {
  ...
  final List<String> badges = ["Basic", "Silver", "Gold", "Premium"];

  final List<int> durations = [1, 3, 6, 12];
  final paymentMethods = ["Cash", "UPI", "Card", "Bank"];
  ...
  void calculateBalance() {
    final total = double.tryParse(totalFeesController.text) ?? 0;
        ...
        child: ListView(
          ...
          children: [
            DropdownButtonFormField<String>(
              value: selectedBadge,
              decoration: const InputDecoration(labelText: "Membership Badge"),
              items: badges
            ...
            DropdownButtonFormField<int>(
              ...
              items: durations
                  .map(
                    (e) => DropdownMenuItem(value: e, child: Text("$e Month")),
                  )
                  .toList(),
              onChanged: (value) {
                setState(() {
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: loading ? null : renewMembership,
                child: loading
