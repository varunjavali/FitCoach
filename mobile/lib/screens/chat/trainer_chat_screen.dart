...
class TrainerChatScreen extends StatefulWidget {
  ...
  @override
  State<TrainerChatScreen> createState() =>
      _TrainerChatScreenState();
}

class _TrainerChatScreenState
    extends State<TrainerChatScreen> {
  ...
  Future<void> loadConversation() async {
    try {
      ...
      final chats = await chatService.getConversation(
        token,
        widget.client.id,
      );
